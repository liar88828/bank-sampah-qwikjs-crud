...
import { useActionMaterial } from "~/action/page.action"
import { LuSearch } from "@qwikest/icons/lucide"
import { Link } from "@builder.io/qwik-city"
import { type MaterialLoader } from "~/type/db/menu.type"

export const MaterialSampah = component$(
  ({ data }: { data: MaterialLoader }) => {
            ...
            <tbody>
              {data.searchMaterial.map((d, i) => (
                <tr key={d.id}>
                  ...
                  <td>{d.berat}Kg</td>
                  <th>
                    <Link href={`material/${d.id}`} class="btn btn-info btn-xs">
                      details
                    </Link>
                  </th>
                </tr>
