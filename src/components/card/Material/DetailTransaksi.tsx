import { $, Resource, Signal, component$, useStore } from "@builder.io/qwik";
import { Link, useLocation } from "@builder.io/qwik-city";
import { LuShoppingCart, LuX } from "@qwikest/icons/lucide";
import { getDate } from "~/lib/date";
import { useActionMaterialBeli } from "~/routes/menu/page/material/[id_material]";
...
export const DetailTransaksi = component$(
  ({ loadData }: { loadData: MaterialDetail }) => {
              ...
              <div class="card-body space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6 md:grid-cols-4">
                  ...
                  <div class="space-y-2 ">
                    ...
                    <Link
                      href={`/menu/page/user/${transaksi?.id_user}?callback=${pathName}`}
                      class="link"
                    >
