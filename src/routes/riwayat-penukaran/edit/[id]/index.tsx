...
export const useUpdate = routeAction$(async (data, { redirect, params }) => {
  ...
  if (material) throw redirect(302, `/riwayat-penukaran/detail/${id}`);
...
export default component$(() => {
  ...
  return (
    <section class="card static bg-neutral text-neutral-content ">
      <Form class="text-cente card-body items-center" action={updateAction}>
        <h1 class="card-title">
        ...
        <div class="card-actions">
          ...
          <Link
            href={`/riwayat-penukaran/detail/${materialData.value?.id}`}
