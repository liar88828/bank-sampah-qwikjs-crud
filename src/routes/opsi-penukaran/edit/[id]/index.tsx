...
export const useUpdate = routeAction$(
  async (data, {redirect, params}) => {
    ...
    if (material) throw redirect(302, `/opsi-penukaran/detail/${id}`);
...
export default component$(() => {
  ...
  return (
    <section class="static card bg-neutral text-neutral-content ">
      ...
      >
        ...
        <div class="card-actions">
          ...
          <Link
            href={`/opsi-penukaran/detail/${materialData.value?.id}`}
